...
----------------------------------------*/
class fitfloss_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('fitfloss_instagram_photo',esc_html__('[ Fitfloss ] Intagram Photo','fitfloss-companion'),array(
			'description' => esc_html__('Fitfloss Instagram Photo Widget','fitfloss-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'fitfloss-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'fitfloss-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'fitfloss-companion'); ?></label>
...
if(!function_exists('fitfloss_instagram_widgets')):
	function fitfloss_instagram_widgets(){
		register_widget('fitfloss_instagram_photo');
	}
	add_action('widgets_init','fitfloss_instagram_widgets');
endif;
