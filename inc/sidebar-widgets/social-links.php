...
class Fitfloss_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'fitfloss_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Fitfloss ] Social Links', 'fitfloss-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'fitfloss-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'fitfloss-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'fitfloss-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'fitfloss-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'fitfloss-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'fitfloss-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'fitfloss-companion'); ?></label>
...
} // Class fitfloss_social_links ends here


// Register and load the widget
function fitfloss_social_links_widget_load() {
	register_widget( 'Fitfloss_social_links' );
}
add_action( 'widgets_init', 'fitfloss_social_links_widget_load' );